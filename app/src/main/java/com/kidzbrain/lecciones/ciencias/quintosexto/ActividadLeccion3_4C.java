package com.kidzbrain.lecciones.ciencias.quintosexto;
...
import com.kidzbrain.fraginteractivos.EjercicioReproduccion;
...
public class ActividadLeccion3_4C extends AppCompatActivity implements View.OnClickListener {
    ...
    private void construirLeccion() {
        ...
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec3_4ciencias_teoria1, R.raw.ciencias3_4_1));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec3_4ciencias_teoria2, R.raw.ciencias3_4_2));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec3_4ciencias_teoria3, R.raw.ciencias3_4_3));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec3_4ciencias_teoria4, R.raw.ciencias3_4_4));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec3_4ciencias_teoria5, R.raw.ciencias3_4_5));
        listaDePasos.add(new EjercicioReproduccion());
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec3_4ciencias_teoria6_fin, R.raw.ciencias3_4_6));
    }
        ...
        api.guardarProgreso(progreso).enqueue(new Callback<ProgresoDto>() {
            ...
            public void onResponse(Call<ProgresoDto> call, Response<ProgresoDto> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(ActividadLeccion3_4C.this, "¡Lección Completada y Guardada!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ActividadLeccion3_4C.this, "Se guardó localmente (Error Servidor)", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ProgresoDto> call, Throwable t) {
                Toast.makeText(ActividadLeccion3_4C.this, "Error de conexión", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
