...
public class ActividadLeccion1_2C extends AppCompatActivity implements View.OnClickListener {
    ...
    private void construirLeccion() {
        ...
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_2ciencias_teoria1, R.raw.teoriaciencias2_1));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_2ciencias_teoria2, R.raw.teoriaciencias2_2));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_2ciencias_teoria3, R.raw.audiesote));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_2ciencias_teoria4, R.raw.teoriaciencias2_3));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_2ciencias_teoria5, R.raw.teoriaciencias2_4));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_2ciencias_teoria6_fin, R.raw.teoriaciencias2_5));
    }
