package com.kidzbrain.lecciones.ciencias.primerosegundo;
...
import com.kidzbrain.fraginteractivos.EjercicioContarCamiones;
import com.kidzbrain.fraginteractivos.EjercicioHabitats;
...
public class ActividadLeccion1_4C extends AppCompatActivity implements View.OnClickListener {
    ...
    private void construirLeccion() {
        ...
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_4ciencias_teoria1, R.raw.biologia1_4_1));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_4ciencias_teoria2, R.raw.biologia1_4_2));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_4ciencias_teoria3, R.raw.biologia1_4_3));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_4ciencias_teoria4, R.raw.biologia1_4_4));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_4ciencias_teoria5, R.raw.biologia1_4_5));
        listaDePasos.add(new EjercicioHabitats());
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_4ciencias_teoria6_fin, R.raw.biologia1_4_7));
    }
        ...
        api.guardarProgreso(progreso).enqueue(new Callback<ProgresoDto>() {
            ...
            public void onResponse(Call<ProgresoDto> call, Response<ProgresoDto> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(ActividadLeccion1_4C.this, "¡Lección Completada y Guardada!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ActividadLeccion1_4C.this, "Se guardó localmente (Error Servidor)", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ProgresoDto> call, Throwable t) {
                Toast.makeText(ActividadLeccion1_4C.this, "Error de conexión", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
