...
public class ActividadLeccion3_3C extends AppCompatActivity implements View.OnClickListener {
    ...
    private void construirLeccion() {
        ...
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec3_3ciencias_teoria1, R.raw.bio5_1));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec3_3ciencias_teoria2, R.raw.bio5_2));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec3_3ciencias_teoria3, R.raw.bio5_3));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec3_3ciencias_teoria4, R.raw.bio5_4));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec3_3ciencias_teoria5_fin, R.raw.bio5_5));
    }
        ...
        api.guardarProgreso(progreso).enqueue(new Callback<ProgresoDto>() {
            ...
            public void onResponse(Call<ProgresoDto> call, Response<ProgresoDto> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(ActividadLeccion3_3C.this, "¡Lección Completada y Guardada!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ActividadLeccion3_3C.this, "Se guardó localmente (Error Servidor)", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ProgresoDto> call, Throwable t) {
                Toast.makeText(ActividadLeccion3_3C.this, "Error de conexión", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
