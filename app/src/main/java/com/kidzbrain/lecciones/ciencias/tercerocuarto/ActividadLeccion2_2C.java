...
public class ActividadLeccion2_2C extends AppCompatActivity implements View.OnClickListener {
    ...
    private void construirLeccion() {
        ...
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_2ciencias_teoria1, R.raw.lec_ciencias5_1));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_2ciencias_teoria2, R.raw.lec_ciencias5_2));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_2ciencias_teoria3, R.raw.lec_ciencias5_3));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_2ciencias_teoria4, R.raw.lec_ciencias5_4));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_2ciencias_teoria5, R.raw.lec_ciencias5_5));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_2ciencias_teoria6_fin, R.raw.lec_ciencias5_6));
    }
        ...
        api.guardarProgreso(progreso).enqueue(new Callback<ProgresoDto>() {
            ...
            public void onResponse(Call<ProgresoDto> call, Response<ProgresoDto> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(ActividadLeccion2_2C.this, "¡Lección Completada y Guardada!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ActividadLeccion2_2C.this, "Se guardó localmente (Error Servidor)", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ProgresoDto> call, Throwable t) {
                Toast.makeText(ActividadLeccion2_2C.this, "Error de conexión", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
