...
import com.kidzbrain.fraginteractivos.EjercicioMateria;
...
public class ActividadLeccion2_1C extends AppCompatActivity implements View.OnClickListener {
    ...
    private void construirLeccion() {
        ...
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_1ciencias_teoria1, R.raw.lec_ciencias4));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_1ciencias_teoria2, R.raw.lec_ciencias4_2));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_1ciencias_teoria3, R.raw.lec_ciencias4_3));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_1ciencias_teoria4, R.raw.lec_ciencias4_4));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_1ciencias_teoria5, R.raw.lec_ciencias4_5));
        listaDePasos.add(new EjercicioMateria());
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_1ciencias_teoria6_fin, R.raw.lec_ciencias4_6));
    }
        ...
        api.guardarProgreso(progreso).enqueue(new Callback<ProgresoDto>() {
            ...
            public void onResponse(Call<ProgresoDto> call, Response<ProgresoDto> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(ActividadLeccion2_1C.this, "¡Lección Completada y Guardada!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ActividadLeccion2_1C.this, "Se guardó localmente (Error Servidor)", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ProgresoDto> call, Throwable t) {
                Toast.makeText(ActividadLeccion2_1C.this, "Error de conexión", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
