package com.kidzbrain.lecciones.matematicas.primerosegundo;
...
import com.kidzbrain.fraginteractivos.EjercicioDecenas1;
import com.kidzbrain.fraginteractivos.EjercicioDecenas2;
import com.kidzbrain.fraginteractivos.EjercicioDecenas3;
import com.kidzbrain.fraginteractivos.EjercicioPatrones1;
import com.kidzbrain.fraginteractivos.EjercicioSeries1;
...
public class ActividadLeccion1_4M extends AppCompatActivity implements View.OnClickListener {
    ...
    private void construirLeccion() {
        ...
        // Teoría (puedes añadir los IDs de audio que grabes)
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_4_teoria1_matematicas, R.raw.mate1_4_1));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_4_teoria2_matematicas, R.raw.mate1_4_2));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_4_teoria3_matematicas, R.raw.mate1_4_3));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_4_teoria4_matematicas, R.raw.mate1_4_4));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_4_teoria5_matematicas, R.raw.mate1_4_5));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_4_teoria6_matematicas, R.raw.mate1_4_6));

        // Ejercicios
        listaDePasos.add(new EjercicioPatrones1());
        listaDePasos.add(new EjercicioSeries1());

        // Fin
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_4_teoria7_fin_matematicas, R.raw.mate1_4_7));
    }
        ...
        api.guardarProgreso(progreso).enqueue(new Callback<ProgresoDto>() {
            ...
            public void onResponse(Call<ProgresoDto> call, Response<ProgresoDto> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(ActividadLeccion1_4M.this, "¡Lección Completada y Guardada!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ActividadLeccion1_4M.this, "Se guardó localmente (Error Servidor)", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ProgresoDto> call, Throwable t) {
                Toast.makeText(ActividadLeccion1_4M.this, "Error de conexión", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
