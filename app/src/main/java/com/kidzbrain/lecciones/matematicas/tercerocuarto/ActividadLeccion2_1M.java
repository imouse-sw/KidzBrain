...
import com.kidzbrain.fraginteractivos.EjercicioDivision;
import com.kidzbrain.fraginteractivos.EjercicioFraccion;
import com.kidzbrain.fraginteractivos.EjercicioMultiplicacion;
...
public class ActividadLeccion2_1M extends AppCompatActivity implements View.OnClickListener {
    ...
    private void construirLeccion() {
        ...
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec4_teoria1, R.raw.mate4_1));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec4_teoria2, R.raw.mate4_2));
        listaDePasos.add(new EjercicioMultiplicacion());
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec4_teoria3, R.raw.mate4_3));
        listaDePasos.add(new EjercicioDivision());
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec4_teoria4, R.raw.mate4_4));
        listaDePasos.add(new EjercicioFraccion());
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec4_teoria5_fin, R.raw.mate4_5));
    }
        ...
        api.guardarProgreso(progreso).enqueue(new Callback<ProgresoDto>() {
            ...
            public void onResponse(Call<ProgresoDto> call, Response<ProgresoDto> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(ActividadLeccion2_1M.this, "¡Lección Completada y Guardada!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ActividadLeccion2_1M.this, "Se guardó localmente (Error Servidor)", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ProgresoDto> call, Throwable t) {
                Toast.makeText(ActividadLeccion2_1M.this, "Error de conexión", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
