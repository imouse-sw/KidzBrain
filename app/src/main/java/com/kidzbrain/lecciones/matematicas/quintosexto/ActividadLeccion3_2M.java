...
import com.kidzbrain.fraginteractivos.EjercicioPorcentajes;
...
public class ActividadLeccion3_2M extends AppCompatActivity implements View.OnClickListener {
    ...
    private void construirLeccion() {
        ...
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec8_teoria1, R.raw.mate8_1));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec8_teoria2, R.raw.mate8_2));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec8_teoria3, R.raw.mate8_3));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec8_teoria4, R.raw.mate8_4));
        listaDePasos.add(new EjercicioPorcentajes());
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec8_teoria5_fin, R.raw.mate8_5));
    }
        ...
        api.guardarProgreso(progreso).enqueue(new Callback<ProgresoDto>() {
            ...
            public void onResponse(Call<ProgresoDto> call, Response<ProgresoDto> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(ActividadLeccion3_2M.this, "¡Lección Completada y Guardada!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ActividadLeccion3_2M.this, "Se guardó localmente (Error Servidor)", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ProgresoDto> call, Throwable t) {
                Toast.makeText(ActividadLeccion3_2M.this, "Error de conexión", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
