...
import com.kidzbrain.fraginteractivos.EjercicioDivisores1;
import com.kidzbrain.fraginteractivos.EjercicioMultiplos1;
...
public class ActividadLeccion2_4M extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nivelActual = getIntent().getIntExtra("nivel", 2);
    ...
    private void construirLeccion() {
        ...
        // Teoría
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_4_teoria1_matematicas, R.raw.mate2_4_1));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_4_teoria2_matematicas, R.raw.mate2_4_2));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_4_teoria3_matematicas, R.raw.mate2_4_3));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_4_teoria4_matematicas, R.raw.mate2_4_4));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_4_teoria5_matematicas, R.raw.mate2_4_5));

        // Ejercicios
        listaDePasos.add(new EjercicioMultiplos1());
        listaDePasos.add(new EjercicioDivisores1());

        // Fin
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec2_4_teoria6_fin_matematicas, R.raw.mate2_4_6));
    }
        ...
        api.guardarProgreso(progreso).enqueue(new Callback<ProgresoDto>() {
            ...
            public void onResponse(Call<ProgresoDto> call, Response<ProgresoDto> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(ActividadLeccion2_4M.this, "¡Lección Completada y Guardada!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ActividadLeccion2_4M.this, "Se guardó localmente (Error Servidor)", Toast.LENGTH_SHORT).show();
                }
                finish();
            }
            ...
            public void onFailure(Call<ProgresoDto> call, Throwable t) {
                Toast.makeText(ActividadLeccion2_4M.this, "Error de conexión", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
