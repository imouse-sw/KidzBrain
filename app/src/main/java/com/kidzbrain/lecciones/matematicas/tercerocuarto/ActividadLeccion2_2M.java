...
import com.kidzbrain.fraginteractivos.EjercicioArea;
import com.kidzbrain.fraginteractivos.EjercicioPerimetro;
...
public class ActividadLeccion2_2M extends AppCompatActivity implements View.OnClickListener {
    ...
    private void construirLeccion() {
        ...
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec5_teoria1, R.raw.mate5_1));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec5_teoria2, R.raw.mate5_2));
        listaDePasos.add(new EjercicioPerimetro());
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec5_teoria3, R.raw.mate5_3));
        listaDePasos.add(new EjercicioArea());
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec5_teoria4, R.raw.mate5_4));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec5_teoria5_fin, R.raw.mate5_5));
    }
        ...
        api.guardarProgreso(progreso).enqueue(new Callback<ProgresoDto>() {
            ...
            public void onResponse(Call<ProgresoDto> call, Response<ProgresoDto> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(ActividadLeccion2_2M.this, "¡Lección Completada y Guardada!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ActividadLeccion2_2M.this, "Se guardó localmente (Error Servidor)", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ProgresoDto> call, Throwable t) {
                Toast.makeText(ActividadLeccion2_2M.this, "Error de conexión", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
