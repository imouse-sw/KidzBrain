...
public class ActividadLeccion1_1M extends AppCompatActivity implements View.OnClickListener {
    ...
    private void construirLeccion() {
        ...
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_teoria1, R.raw.teoria1voz));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_teoria2, R.raw.teoria2voz));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_teoria3, R.raw.teoria3voz));
        listaDePasos.add(new EjercicioContarCamiones());
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(R.layout.fragment_lec1_teoria4_fin, R.raw.teoria4voz));
    }
        ...
        api.guardarProgreso(progreso).enqueue(new Callback<ProgresoDto>() {
            ...
            public void onResponse(Call<ProgresoDto> call, Response<ProgresoDto> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(ActividadLeccion1_1M.this, "¡Lección Completada y Guardada!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ActividadLeccion1_1M.this, "Se guardó localmente (Error Servidor)", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ProgresoDto> call, Throwable t) {
                Toast.makeText(ActividadLeccion1_1M.this, "Error de conexión", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
