...
public class MultiplosDMusica {
    private static MediaPlayer cancionAReproducir;

    public static void reproduce(Context context) {
        if(cancionAReproducir == null) {
            cancionAReproducir = MediaPlayer.create(context.getApplicationContext(), R.raw.bg_jazz_carnival); // Cambia "bg_musica2" por el nombre de tu archivo
