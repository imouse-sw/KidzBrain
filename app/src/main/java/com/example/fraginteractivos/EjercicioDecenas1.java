...
public class EjercicioDecenas1 extends PlantillaFragmentoInteractivo implements View.OnClickListener {
    Integer d1, d2, u1, u2;
    int d1c = 3, u1c = 3, d2c = 4, u2c = 8;
    Button boton;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View vistita = inflater.inflate(R.layout.fragment_lec3_int1_dec1, container, false);
