...
public class EjercicioDecenas3 extends PlantillaFragmentoInteractivo implements View.OnClickListener {
    Integer d1, d2, u1, u2, c2;
    int d1c = 6, u1c = 9, d2c = 4, u2c = 9, c2c = 1;
    Button boton;
    EditText etD1, etD2, etU1, etU2, etC2;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View vistita = inflater.inflate(R.layout.fragment_lec3_int1_dec3, container, false);
        ...
        etC2 = vistita.findViewById(R.id.edit_centenas);
    ...
    protected void comprobarRespuesta() {
        ...
        String c2Txt = etC2.getText().toString().trim();
        ...
        if(d1Txt.isEmpty() || d2Txt.isEmpty() || u1Txt.isEmpty() || u2Txt.isEmpty()) {
            ...
            c2 = Integer.parseInt(c2Txt);

            if(d1 == d1c && d2 == d2c && u1 == u1c && u2 == u2c && c2 == c2c) {
                if(actividad!=null) {
                ...
                Toast.makeText(getContext(), "Una o más respuestas son incorrectas. ¡Revisa de nuevo!", Toast.LENGTH_SHORT).show();
            }
        }
    }
