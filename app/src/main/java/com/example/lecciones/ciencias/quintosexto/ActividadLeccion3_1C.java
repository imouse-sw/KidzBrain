...
public class ActividadLeccion3_1C extends AppCompatActivity implements View.OnClickListener
{
    ...
    private void construirLeccion() {
        ...
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(
                R.layout.fragment_lec3_1ciencias_teoria1,
                R.raw.bio3_1));

        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(
                R.layout.fragment_lec3_1ciencias_teoria2,
                R.raw.bio3_2));

        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(
                R.layout.fragment_lec3_1ciencias_teoria3,
                R.raw.bio3_3));
        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(
                R.layout.fragment_lec3_1ciencias_teoria4,
                R.raw.bio3_4));

        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(
                R.layout.fragment_lec3_1ciencias_teoria5,
                R.raw.bio3_5));

        listaDePasos.add(PlantillaFragmentoTeoria.getInstance(
                R.layout.fragment_lec3_1ciencias_teoria6_fin,
                R.raw.bio3_6));
